    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">sAdmin</div>
            </a>
            ...
            <li class="nav-item {{ (Request::is('submissions')) ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/submissions') }}">
                    <i class="fas fa-inbox"></i>
                    <span>Zgłoszenia</span></a>
            </li>

            <li class="nav-item {{ (Request::is('submissions/new')) ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/submissions/new') }}">
                    <i class="fas fa-plus-circle"></i>
                    <span>Dodaj zgłoszenie</span></a>
            </li>
            ...
            <li class="nav-item {{ (Request::is('users/new')) ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/users/new') }}">
